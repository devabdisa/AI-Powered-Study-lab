...
1. **📚 Structured Notes:** Transforms raw text/PDFs into beginner-friendly, beautifully formatted Markdown notes with complete *Learning Objectives*, *Real-Life Examples*, and *Quick Tests*.
...
*   **AI Engine:** Google Gemini AI API (`@google/generative-ai`) utilizing `gemini-1.5-pro` for complex reasoning.
